...
public class HeadAnDTailGame {
    public static void main(String[] args) {
        ...
        do {
            ...
            if(oneMoreGame.equalsIgnoreCase("HEAD") || oneMoreGame.equalsIgnoreCase("TAIL")) {
                if (oneMoreGame.equalsIgnoreCase("flip")) {
                    System.out.println("You are lucky, it is your day today.");
                } else {
                    System.out.println("Sorry, that was not the correct choice!");
                }
            } else {
                System.out.println("Please enter valid selection Head or Tail ");
            }
